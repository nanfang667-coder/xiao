...
export const provinceCities: Record<string, string[]> = {
  ...
  重庆市: [
    ...
    "渝北区", "巴南区", "北碚区", "万州区", "涪陵区", "永川区",
    "江津区", "合川区", "璧山区", "铜梁区", "潼南区", "荣昌区",
    "大足区", "黔江区", "长寿区", "南川区", "綦江区", "开州区",
  ],
  河北省: [
...
export function districtsOfCity(city: string): string[] {
  return citiesOfProvince(city);
}
