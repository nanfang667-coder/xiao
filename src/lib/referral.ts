...
// 邀请码直接放在根路径下（如 fenglou1.com/AB3），这些是已有页面占用的路径名，
// 邀请码不能跟它们撞上（生成的码全是大写字母/数字，这里转小写做保险比较）
const RESERVED_PATHS = ["admin", "alley", "adminzhangzhang", "listing", "login", "promote", "r", "register", "safety", "teacher", "vip", "uploads"];
